...
class Poupanca(Conta): # herança ou seja todos os atributos de conta, poupanca vai ter
    def __init__(self, titular, numero, saldo): # sobrescrevo os valores estanciados no inicio
        super().__init__(titular, numero, saldo) #quero recuperar da classe pai os atributos (titular, numero e saldo) 
        self.juros = 0.005 #e agora quero aplicar o juros
